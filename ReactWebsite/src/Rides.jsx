...
import ducati from '../src/Assets/ducati.jpg'
import { NavLink } from "react-router-dom";

const Rides = () => {
  return (
    <section className="pb-20 pt-20 relative" style={{ top: "-6rem"}}>
      <div className="relative">
        <img src={ducati} alt="Ducati" />

        <div className="absolute inset-x-0 top-1/4 flex justify-center gap-8">
          <NavLink to="/addride">
