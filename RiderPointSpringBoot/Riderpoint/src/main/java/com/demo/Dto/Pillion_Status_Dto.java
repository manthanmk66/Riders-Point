...
public class Pillion_Status_Dto {
	private int status_id ;
	private RpDetails rp_id ;
	private  double avg_expense;
	
	
	public Pillion_Status_Dto() {
		super();
	}
	public Pillion_Status_Dto(int status_id, RpDetails rp_id, double avg_expense) {
		super();
	...
	public String toString() {
		return "Pillion_Status_Dto [status_id=" + status_id + ", rp_id=" + rp_id + ", avg_expense=" + avg_expense + "]";
	}
