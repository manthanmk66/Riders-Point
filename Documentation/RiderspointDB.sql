...
drop table if exists pillion_route_details;
	...
	create table rp_details(rider_id int primary key auto_increment,name varchar(30),mobile_no varchar(10),address varchar(100),alert varchar(10));
	...
	create table suggestion_table(rp_id int,suggestion varchar(100),constraint fk_status_rid foreign key(rp_id) references rp_details(rp_id));
