...
drop table if exists pillion_route_details;
	...
	create table rp_details(rider_id int primary key auto_increment,name varchar(30),mobile_no varchar(10),address varchar(100));
	create table status(status_id int primary key auto_increment,rider_id int,bike varchar(20), expense varchar(20),constraint fk_status_rid foreign key(rp_id) references rider_details(rider_id));
	...
	create table loginrider(id int,username varchar(20),password varchar(20) ,constraint fk_rd_pass_rid foreign 			key(id) references rp_details(rp_id));
	...
	create table status_pillion(status_id int primary key 					auto_increment,pillion_id int,avg_expense varchar(20),constraint 		fk_statusp_rid foreign key(pillion_id) references 				rp_details(rp_id));
	...
	create table loginpillion(id int,username varchar(20),password varchar(20) ,constraint fk_rd_pass_rid foreign 			key(id) references rp_details(rp_id));
